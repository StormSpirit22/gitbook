...
​	3）更新Redis数据：MySQL 的数据操作binlog，来更新到Redis
...
这里说的是增量,指的是mysql的 update、insert、delete 变更数据。
...
<img src="../../.gitbook/assets/hc-cache-5.png" alt="image-20220309161908991" style="zoom:50%;" />
